...
[_DANGEROUS] = LAYOUT_ortho_4x12_1x2uC(
...
const uint16_t PROGMEM oneshot_dangerous[] = {};
const uint16_t PROGMEM combo_keypress_q[] = {KC_J, JC_G, COMBO_END};
const uint16_t PROGMEM combo_keypress_z[] = {KC_O, KC_K, COMBO_END};
