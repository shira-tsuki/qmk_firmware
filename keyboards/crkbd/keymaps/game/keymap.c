...
[_MAIN] = LAYOUT_split_3x6_3_ex2(
    KC_TAB,     KC_Q,       KC_W,       KC_E,       KC_R,       KC_T,       KC_UP,              KC_HOME,    KC_COMMA,   KC_DOT,     KC_SLASH,   KC_QUOTE,   KC_EQUAL,   KC_PGUP,
    ...
    KC_GRAVE,   KC_Z,       KC_X,       KC_C,       KC_V,       KC_B,                                       KC_N,       KC_M,       KC_COMMA,   KC_DOT,     KC_SLASH,   KC_PGDN,
                            KC_LGUI, LT(_SHORTCUT, KC_BSPC), KC_SPC,                             LT(_SYMBOL, KC_SPC), LT(_FUNCTION, KC_ENT), KC_DELETE
),
...
[_GAME] = LAYOUT_split_3x6_3_ex2(
    ...
    KC_ESCAPE,  KC_A,       KC_S,       KC_D,       KC_F,       KC_G,       KC_DOWN,            KC_END,     KC_H,       KC_J,       KC_K,       KC_L,       KC_SCLN,    KC_QUOTE,
    KC_GRAVE,   KC_Z,       KC_X,       KC_C,       KC_V,       KC_B,                                       KC_N,       KC_M,       KC_COMMA,   KC_DOT,     KC_SLASH,   KC_PGDN,
                            KC_LGUI,    KC_BSPC,    KC_T,                             LT(_SYMBOL, KC_SPC), LT(_FUNCTION, KC_ENT), KC_DELETE
),
...
[_SHORTCUT] = LAYOUT_split_3x6_3_ex2(
    ...
    KC_F13,     KC_F14,     KC_F15,     KC_F16,    KC_F17,      KC_F18,     UG_NEXT,            _______,    KC_F19,     KC_F20,  KC_F21,  KC_F22, KC_F23, KC_F24,
...
const uint16_t PROGMEM layer_to_main2[] = {KC_HOME, KC_END, COMBO_END};
