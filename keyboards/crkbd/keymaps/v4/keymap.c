...
[_MAIN] = LAYOUT_split_3x6_3(
    KC_TAB,     KC_J,       KC_G,       KC_M,       KC_P,       KC_V, _______, _______,                 KC_COMMA,        KC_DOT,     KC_SLASH,   KC_QUOTE,   KC_EQUAL,   KC_PGUP,
    KC_ESCAPE,  KEY_1_1,    KEY_1_2,    KEY_1_3,    KC_D,       KC_B, _______, _______,                  KC_SEMICOLON,    KC_A,       KEY_1_8,    KEY_1_9,    KEY_1_10,   KC_BACKSLASH,
...
[_QWERTY] = LAYOUT_split_3x6_3(
    ...
    KC_ESCAPE, KC_A, KC_S, KC_D, KC_F, KC_G,_______, _______,  KC_H, KC_J,  KC_K,  KC_L, KC_SEMICOLON, KC_QUOTE,
...
[_SYMBOL] = LAYOUT_split_3x6_3(
    ...
    _______,  _______,   _______,   _______,   _______,   _______, _______, _______,   _______,   _______,    _______,    KC_LEFT_BRACKET, KC_RIGHT_BRACKET, _______,
    _______, _______,   _______,   _______,   _______,  _______,  _______,  _______, _______, KC_LEFT_CURLY_BRACE, KC_RIGHT_CURLY_BRACE,  KC_PSCR,
...
[_SHORTCUT] = LAYOUT_split_3x6_3(
    LGUI(KC_LEFT_BRACKET), LCTL(KC_X), LCTL(KC_C), LCTL(KC_V), RCS(KC_V), KC_PSCR,_______, _______,       _______, LCTL(KC_PAGE_UP), LCTL(KC_PAGE_DOWN), LCTL(KC_Z), LCTL(KC_A), LGUI(KC_RIGHT_BRACKET),
